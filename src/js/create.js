...
var addPositionModal = function() {
    ...
    // Checkbox: whether the position has a write-in
    var positionVoteRequired = $('#position-required');
    // Checkbox: whether a vote from the user is required
