(function() {
        ...
        return $('#delete-position-yes').click(function() {
          ...
          return $.ajax({
            ...
            success: function(data) {
              var response;
              response = JSON.parse(data);
              if (response['status'] === 'OK') return html.slideUp(500);
            }
          });
        });
      });
  ...
  Position = (function() {
    ...
    Position.prototype.submitData = function(e) {
      ...
      method = 'add_position';
      if (this.id) method = 'update_position';
      data = {
        'method': method,
        'position': position
      };
    ...
    Position.prototype.resetSubmitBtn = function() {
      ...
      if (this.id) text = 'Update Position';
    ...
    Position.prototype.addCandidateSlot = function() {
      ...
      return $("#" + id).click(function() {
        ...
        if (indexPtr !== -1) _this.candidateIDs.splice(indexPtr, 1);
