...
Form = ->
    ...
    createPositionHTML = (position) ->
        id = position['pageId']
        html = $("
        <li class='btn-group' id='position-#{id}'>
            <a class='btn btn-info'><i class='icon-user icon-white'></i>
                #{position['name']}
            </a>
            ...
            <ul class='dropdown-menu'>
                <li>
                    <a id='position-#{id}-edit'><i class='icon-pencil'></i>
                        Edit
                    </a>
                </li>
                <li>
                    <a id='position-#{id}-delete'><i class='icon-trash'></i>
                        Delete
                    </a>
                </li>
            </ul>
