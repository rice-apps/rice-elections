...
from models.admin_.organization_panel_.election_panel_.information import ElectionUpdateHandler
...
app = webapp2.WSGIApplication([
    ...
    ('/admin/organization-panel/election-panel/information/update', ElectionUpdateHandler),
